...
public final class EnemyTemplates {
    ...
    public static final Enemy ANT = new Enemy(0, 0, 3, PASSIVE_BASICO, PISTOL, HITBOX_NORMAL, ATRIBUTOS_BASICO, "ANT");
    ...
    public static final Enemy FLY = new Enemy(0, 0, 3, PASSIVE_BASICO, PISTOL, HITBOX_NORMAL, ATRIBUTOS_BASICO, "FLY");
    public static final Enemy IMP = new Enemy(0, 0, 3, PASSIVE_BASICO, PISTOL, HITBOX_NORMAL, ATRIBUTOS_BASICO, "IMP");
    public static final Enemy LARVA = new Enemy(0, 0, 3, PASSIVE_BASICO, PISTOL, HITBOX_NORMAL, ATRIBUTOS_BASICO, "LARVA");
    public static final Enemy SLIME = new Enemy(0, 0, 3, PASSIVE_BASICO, PISTOL, HITBOX_NORMAL, ATRIBUTOS_BASICO, "SLIME");
