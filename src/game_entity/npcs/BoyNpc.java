...
import game_entity.entity_sprites.BoySprite;
...
public class BoyNpc extends GameEntity implements MovableNpc{
    // Hitbox do npc
     ...
     */
    public BoyNpc(float worldPosX, float worldPosY, int velocity) {
    ...
    private void setDialogues () {
        this.dialogues[0] = "Você viu o que aconteceu ali dentro?\nEsse lugar está condenado, tudo destruído!\nVi pela janela umas criaturas estranhas...\nVocê vai entrar lá para verificar?! Loucura!";
    }
