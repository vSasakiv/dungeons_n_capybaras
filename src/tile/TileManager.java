...
public class TileManager {
     ...
     * cada tile em uma posição especifica do vetor tile[]
     */
    public void getImage () {
        try {
            tile[0] = new Tile();
            tile[0].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Ground/grass1.png"));

            tile[1] = new Tile();
            tile[1].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Ground/grass2.png"));

            tile[2] = new Tile();
            tile[2].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Ground/grass3.png"));

            tile[3] = new Tile();
            tile[3].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Ground/grass4.png"));

            tile[4] = new Tile();
            tile[4].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Ground/grass4.png"));

            tile[5] = new Tile();
            tile[5].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Water/TilesetWater_169.png"));
            
            tile[6] = new Tile();
            tile[6].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Water/TilesetWater_170.png"));
           
            tile[7] = new Tile();
            tile[7].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Water/TilesetWater_171.png"));
            
            tile[8] = new Tile();
            tile[8].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Water/TilesetWater_197.png"));
            
            tile[9] = new Tile();
            tile[9].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Water/TilesetWater_198.png"));
            
            tile[10] = new Tile();
            tile[10].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Water/TilesetWater_199.png"));
            
            tile[11] = new Tile();
            tile[11].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Field/TilesetField_17.png"));
            
            tile[12] = new Tile();
            tile[12].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Field/TilesetField_21.png"));

            tile[13] = new Tile();
            tile[13].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Field/TilesetField_23.png"));

            tile[14] = new Tile();
            tile[14].image = ImageIO.read(getClass().getResourceAsStream("/resources/Tiles/Field/TilesetField_27.png"));
     ...
     * 
     * Este método é responsável por implementar a lógica para a rendereização dos tiles
     */
     ...
     * 
     * Este método é resposável por ler uma matriz de números inteiros, escrita em um txt,
